...
!function(e){var t="object"==typeof window&&window||"object"==typeof self&&self;"undefined"!=typeof exports?e(exports):t&&(t.hljs=e({}),"function"==typeof define)&&define.amd&&define([],function(){return t.hljs})}(function(r){function v(e){return e.replace(/[&<>]/gm,function(e){return h[e]})}function f(e){return e.nodeName.toLowerCase()}function E(e,t){e=e&&e.exec(t);return e&&0===e.index}function i(e){return a.test(e)}function o(e){var t,n={},r=Array.prototype.slice.call(arguments,1);for(t in e)n[t]=e[t];return r.forEach(function(e){for(t in e)n[t]=e[t]}),n}function s(e){var a=[];return function e(t,n){for(var r=t.firstChild;r;r=r.nextSibling)3===r.nodeType?n+=r.nodeValue.length:1===r.nodeType&&(a.push({event:"start",offset:n,node:r}),n=e(r,n),f(r).match(/br|hr|img|input/)||a.push({event:"stop",offset:n,node:r}));return n}(e,0),a}function l(e,t,n){function r(){return e.length&&t.length?e[0].offset!==t[0].offset?e[0].offset<t[0].offset?e:t:"start"===t[0].event?e:t:e.length?e:t}function a(e){o+="<"+f(e)+b.map.call(e.attributes,function(e){return" "+e.nodeName+'="'+v(e.value)+'"'}).join("")+">"}function c(e){o+="</"+f(e)+">"}function i(e){("start"===e.event?a:c)(e.node)}for(var s=0,o="",l=[];e.length||t.length;){var u=r();if(o+=v(n.substring(s,u[0].offset)),s=u[0].offset,u===e){for(l.reverse().forEach(c);i(u.splice(0,1)[0]),(u=r())===e&&u.length&&u[0].offset===s;);l.reverse().forEach(a)}else"start"===u[0].event?l.push(u[0].node):l.pop(),i(u.splice(0,1)[0])}return o+v(n.substr(s))}function w(c){function i(e){return e&&e.source||e}function s(e,t){return new RegExp(i(e),"m"+(c.cI?"i":"")+(t?"g":""))}!function t(n,e){var r,a;n.compiled||(n.compiled=!0,n.k=n.k||n.bK,n.k&&(r={},a=function(t,e){(e=c.cI?e.toLowerCase():e).split(" ").forEach(function(e){e=e.split("|"),r[e[0]]=[t,e[1]?Number(e[1]):1]})},"string"==typeof n.k?a("keyword",n.k):p(n.k).forEach(function(e){a(e,n.k[e])}),n.k=r),n.lR=s(n.l||/\w+/,!0),e&&(n.bK&&(n.b="\\b("+n.bK.split(" ").join("|")+")\\b"),n.b||(n.b=/\B|\b/),n.bR=s(n.b),n.e||n.eW||(n.e=/\B|\b/),n.e&&(n.eR=s(n.e)),n.tE=i(n.e)||"",n.eW)&&e.tE&&(n.tE+=(n.e?"|":"")+e.tE),n.i&&(n.iR=s(n.i)),null==n.r&&(n.r=1),n.c||(n.c=[]),n.c=Array.prototype.concat.apply([],n.c.map(function(e){return(t="self"===e?n:e).v&&!t.cached_variants&&(t.cached_variants=t.v.map(function(e){return o(t,{v:null},e)})),t.cached_variants||(t.eW?[o(t)]:[t]);var t})),n.c.forEach(function(e){t(e,n)}),n.starts&&t(n.starts,e),e=n.c.map(function(e){return e.bK?"\\.?("+e.b+")\\.?":e.b}).concat([n.tE,n.i]).map(i).filter(Boolean),n.t=e.length?s(e.join("|"),!0):{exec:function(){return null}})}(c)}function x(e,t,a,n){function c(e,t,n,r){r='<span class="'+(r?"":C.classPrefix);return(r+=e+'">')+t+(n?"":R)}function r(){var e,t,n,r,a;if(!u.k)return v(g);for(n="",u.lR.lastIndex=e=0,t=u.lR.exec(g);t;)n+=v(g.substring(e,t.index)),r=u,a=t,a=l.cI?a[0].toLowerCase():a[0],(r=r.k.hasOwnProperty(a)&&r.k[a])?(d+=r[1],n+=c(r[0],v(t[0]))):n+=v(t[0]),e=u.lR.lastIndex,t=u.lR.exec(g);return n+v(g.substr(e))}function i(){var e,t;b+=null!=u.sL?(t="string"==typeof u.sL)&&!M[u.sL]?v(g):(e=t?x(u.sL,g,!0,f[u.sL]):_(g,u.sL.length?u.sL:void 0),0<u.r&&(d+=e.r),t&&(f[u.sL]=e.top),c(e.language,e.value,!1,!0)):r(),g=""}function s(e){b+=e.cN?c(e.cN,"",!0):"",u=Object.create(e,{parent:{value:u}})}function o(e,t){if(g+=e,null==t)return i(),0;e=function(e,t){for(var n=0,r=t.c.length;n<r;n++)if(E(t.c[n].bR,e))return t.c[n]}(t,u);if(e)return e.skip?g+=t:(e.eB&&(g+=t),i(),e.rB||e.eB||(g=t)),s(e),e.rB?0:t.length;var n,r=function e(t,n){if(E(t.eR,n)){for(;t.endsParent&&t.parent;)t=t.parent;return t}return t.eW?e(t.parent,n):void 0}(u,t);if(r){var e=u;for(e.skip?g+=t:(e.rE||e.eE||(g+=t),i(),e.eE&&(g=t));u.cN&&(b+=R),u.skip||(d+=u.r),(u=u.parent)!==r.parent;);return r.starts&&s(r.starts),e.rE?0:t.length}if(e=t,n=u,!a&&E(n.iR,e))throw new Error('Illegal lexeme "'+t+'" for mode "'+(u.cN||"<unnamed>")+'"');return g+=t,t.length||1}var l=y(e);if(!l)throw new Error('Unknown language: "'+e+'"');w(l);for(var u=n||l,f={},b="",p=u;p!==l;p=p.parent)p.cN&&(b=c(p.cN,"",!0)+b);var g="",d=0;try{for(var h,m,N=0;u.t.lastIndex=N,h=u.t.exec(t);)m=o(t.substring(N,h.index),h[0]),N=h.index+m;for(o(t.substr(N)),p=u;p.parent;p=p.parent)p.cN&&(b+=R);return{r:d,value:b,language:e,top:u}}catch(e){if(e.message&&-1!==e.message.indexOf("Illegal"))return{r:0,value:v(t)};throw e}}function _(n,e){e=e||C.languages||p(M);var r={r:0,value:v(n)},a=r;return e.filter(y).forEach(function(e){var t=x(e,n,!1);t.language=e,t.r>a.r&&(a=t),t.r>r.r&&(a=r,r=t)}),a.language&&(r.second_best=a),r}function u(e){return C.tabReplace||C.useBR?e.replace(c,function(e,t){return C.useBR&&"\n"===e?"<br>":C.tabReplace?t.replace(/\t/g,C.tabReplace):""}):e}function t(e){var t,n,r,a,c=function(e){var t,n,r,a=e.className+" ";if(a+=e.parentNode?e.parentNode.className:"",e=d.exec(a))return y(e[1])?e[1]:"no-highlight";for(t=0,n=(a=a.split(/\s+/)).length;t<n;t++)if(i(r=a[t])||y(r))return r}(e);i(c)||(C.useBR?(n=document.createElementNS("http://www.w3.org/1999/xhtml","div")).innerHTML=e.innerHTML.replace(/\n/g,"").replace(/<br[ \/]*>/g,"\n"):n=e,a=n.textContent,t=c?x(c,a,!0):_(a),(n=s(n)).length&&((r=document.createElementNS("http://www.w3.org/1999/xhtml","div")).innerHTML=t.value,t.value=l(n,s(r),a)),t.value=u(t.value),e.innerHTML=t.value,e.className=(n=e.className,r=c,a=t.language,r=r?g[r]:a,a=[n.trim()],n.match(/\bhljs\b/)||a.push("hljs"),-1===n.indexOf(r)&&a.push(r),a.join(" ").trim()),e.result={language:t.language,re:t.r},t.second_best&&(e.second_best={language:t.second_best.language,re:t.second_best.r}))}function n(){var e;n.called||(n.called=!0,e=document.querySelectorAll("pre code"),b.forEach.call(e,t))}function y(e){return e=(e||"").toLowerCase(),M[e]||M[g[e]]}var b=[],p=Object.keys,M={},g={},a=/^(no-?highlight|plain|text)$/i,d=/\blang(?:uage)?-([\w-]+)\b/i,c=/((^(<[^>]+>|\t|)+|(?:\n)))/gm,R="</span>",C={classPrefix:"hljs-",tabReplace:null,useBR:!1,languages:void 0},h={"&":"&amp;","<":"&lt;",">":"&gt;"};return r.highlight=x,r.highlightAuto=_,r.fixMarkup=u,r.highlightBlock=t,r.configure=function(e){C=o(C,e)},r.initHighlighting=n,r.initHighlightingOnLoad=function(){addEventListener("DOMContentLoaded",n,!1),addEventListener("load",n,!1)},r.registerLanguage=function(t,e){(e=M[t]=e(r)).aliases&&e.aliases.forEach(function(e){g[e]=t})},r.listLanguages=function(){return p(M)},r.getLanguage=y,r.inherit=o,r.IR="[a-zA-Z]\\w*",r.UIR="[a-zA-Z_]\\w*",r.NR="\\b\\d+(\\.\\d+)?",r.CNR="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",r.BNR="\\b(0b[01]+)",r.RSR="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",r.BE={b:"\\\\[\\s\\S]",r:0},r.ASM={cN:"string",b:"'",e:"'",i:"\\n",c:[r.BE]},r.QSM={cN:"string",b:'"',e:'"',i:"\\n",c:[r.BE]},r.PWM={b:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|like)\b/},r.C=function(e,t,n){e=r.inherit({cN:"comment",b:e,e:t,c:[]},n||{});return e.c.push(r.PWM),e.c.push({cN:"doctag",b:"(?:TODO|FIXME|NOTE|BUG|XXX):",r:0}),e},r.CLCM=r.C("//","$"),r.CBCM=r.C("/\\*","\\*/"),r.HCM=r.C("#","$"),r.NM={cN:"number",b:r.NR,r:0},r.CNM={cN:"number",b:r.CNR,r:0},r.BNM={cN:"number",b:r.BNR,r:0},r.CSSNM={cN:"number",b:r.NR+"(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?",r:0},r.RM={cN:"regexp",b:/\//,e:/\/[gimuy]*/,i:/\n/,c:[r.BE,{b:/\[/,e:/\]/,r:0,c:[r.BE]}]},r.TM={cN:"title",b:r.IR,r:0},r.UTM={cN:"title",b:r.UIR,r:0},r.METHOD_GUARD={b:"\\.\\s*"+r.UIR,r:0},r}),hljs.registerLanguage("xml",function(e){var t={eW:!0,i:/</,r:0,c:[{cN:"attr",b:"[A-Za-z0-9\\._:-]+",r:0},{b:/=\s*/,r:0,c:[{cN:"string",endsParent:!0,v:[{b:/"/,e:/"/},{b:/'/,e:/'/},{b:/[^\s"'=<>`]+/}]}]}]};return{aliases:["html","xhtml","rss","atom","xjb","xsd","xsl","plist"],cI:!0,c:[{cN:"meta",b:"<!DOCTYPE",e:">",r:10,c:[{b:"\\[",e:"\\]"}]},e.C("\x3c!--","--\x3e",{r:10}),{b:"<\\!\\[CDATA\\[",e:"\\]\\]>",r:10},{b:/<\?(php)?/,e:/\?>/,sL:"php",c:[{b:"/\\*",e:"\\*/",skip:!0}]},{cN:"tag",b:"<style(?=\\s|>|$)",e:">",k:{name:"style"},c:[t],starts:{e:"</style>",rE:!0,sL:["css","xml"]}},{cN:"tag",b:"<script(?=\\s|>|$)",e:">",k:{name:"script"},c:[t],starts:{e:"<\/script>",rE:!0,sL:["actionscript","javascript","handlebars","xml"]}},{cN:"meta",v:[{b:/<\?xml/,e:/\?>/,r:10},{b:/<\?\w+/,e:/\?>/}]},{cN:"tag",b:"</?",e:"/?>",c:[{cN:"name",b:/[^\/><\s]+/,r:0},t]}]}}),hljs.registerLanguage("javascript",function(e){var t="[A-Za-z$_][0-9A-Za-z$_]*",n={keyword:"in of if for while finally var new function do return void else break catch instanceof with throw case default try this switch continue typeof delete let yield const export super debugger as async await static import from as",literal:"true false null undefined NaN Infinity",built_in:"eval isFinite isNaN parseFloat parseInt decodeURI decodeURIComponent encodeURI encodeURIComponent escape unescape Object Function Boolean Error EvalError InternalError RangeError ReferenceError StopIteration SyntaxError TypeError URIError Number Math Date String RegExp Array Float32Array Float64Array Int16Array Int32Array Int8Array Uint16Array Uint32Array Uint8Array Uint8ClampedArray ArrayBuffer DataView JSON Intl arguments require module console window document Symbol Set Map WeakSet WeakMap Proxy Reflect Promise"},r={cN:"number",v:[{b:"\\b(0[bB][01]+)"},{b:"\\b(0[oO][0-7]+)"},{b:e.CNR}],r:0},a={cN:"subst",b:"\\$\\{",e:"\\}",k:n,c:[]},c={cN:"string",b:"`",e:"`",c:[e.BE,a]},a=(a.c=[e.ASM,e.QSM,c,r,e.RM],a.c.concat([e.CBCM,e.CLCM]));return{aliases:["js","jsx"],k:n,c:[{cN:"meta",r:10,b:/^\s*['"]use (strict|asm)['"]/},{cN:"meta",b:/^#!/,e:/$/},e.ASM,e.QSM,c,e.CLCM,e.CBCM,r,{b:/[{,]\s*/,r:0,c:[{b:t+"\\s*:",rB:!0,r:0,c:[{cN:"attr",b:t,r:0}]}]},{b:"("+e.RSR+"|\\b(case|return|throw)\\b)\\s*",k:"return throw case",c:[e.CLCM,e.CBCM,e.RM,{cN:"function",b:"(\\(.*?\\)|"+t+")\\s*=>",rB:!0,e:"\\s*=>",c:[{cN:"params",v:[{b:t},{b:/\(\s*\)/},{b:/\(/,e:/\)/,eB:!0,eE:!0,k:n,c:a}]}]},{b:/</,e:/(\/\w+|\w+\/)>/,sL:"xml",c:[{b:/<\w+\s*\/>/,skip:!0},{b:/<\w+/,e:/(\/\w+|\w+\/)>/,skip:!0,c:[{b:/<\w+\s*\/>/,skip:!0},"self"]}]}],r:0},{cN:"function",bK:"function",e:/\{/,eE:!0,c:[e.inherit(e.TM,{b:t}),{cN:"params",b:/\(/,e:/\)/,eB:!0,eE:!0,c:a}],i:/\[|%/},{b:/\$[(.]/},e.METHOD_GUARD,{cN:"class",bK:"class",e:/[{;=]/,eE:!0,i:/[:"\[\]]/,c:[{bK:"extends"},e.UTM]},{bK:"constructor",e:/\{/,eE:!0}],i:/#(?!!)/}}),hljs.registerLanguage("json",function(e){var t={literal:"true false null"},n=[e.QSM,e.CNM],r={e:",",eW:!0,eE:!0,c:n,k:t},a={b:"{",e:"}",c:[{cN:"attr",b:/"/,e:/"/,c:[e.BE],i:"\\n"},e.inherit(r,{b:/:/})],i:"\\S"},e={b:"\\[",e:"\\]",c:[e.inherit(r)],i:"\\S"};return n.splice(n.length,0,a,e),{c:n,k:t,i:"\\S"}}),hljs.registerLanguage("php",function(e){var t={b:"\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*"},n={cN:"meta",b:/<\?(php)?|\?>/},r={cN:"string",c:[e.BE,n],v:[{b:'b"',e:'"'},{b:"b'",e:"'"},e.inherit(e.ASM,{i:null}),e.inherit(e.QSM,{i:null})]},a={v:[e.BNM,e.CNM]};return{aliases:["php3","php4","php5","php6"],cI:!0,k:"and include_once list abstract global private echo interface as static endswitch array null if endwhile or const for endforeach self var while isset public protected exit foreach throw elseif include __FILE__ empty require_once do xor return parent clone use __CLASS__ __LINE__ else break print eval new catch __METHOD__ case exception default die require __FUNCTION__ enddeclare final try switch continue endfor endif declare unset true false trait goto instanceof insteadof __DIR__ __NAMESPACE__ yield finally",c:[e.HCM,e.C("//","$",{c:[n]}),e.C("/\\*","\\*/",{c:[{cN:"doctag",b:"@[A-Za-z]+"}]}),e.C("__halt_compiler.+?;",!1,{eW:!0,k:"__halt_compiler",l:e.UIR}),{cN:"string",b:/<<<['"]?\w+['"]?$/,e:/^\w+;?$/,c:[e.BE,{cN:"subst",v:[{b:/\$\w+/},{b:/\{\$/,e:/\}/}]}]},n,{cN:"keyword",b:/\$this\b/},t,{b:/(::|->)+[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/},{cN:"function",bK:"function",e:/[;{]/,eE:!0,i:"\\$|\\[|%",c:[e.UTM,{cN:"params",b:"\\(",e:"\\)",c:["self",t,e.CBCM,r,a]}]},{cN:"class",bK:"class interface",e:"{",eE:!0,i:/[:\(\$"]/,c:[{bK:"extends implements"},e.UTM]},{bK:"namespace",e:";",i:/[\.']/,c:[e.UTM]},{bK:"use",e:";",c:[e.UTM]},{b:"=>"},r,a]}});
